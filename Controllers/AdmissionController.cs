    ...
    public class AdmissionController : Controller
    {
        ...
        public ActionResult PersonalInformation(int? applicationId, string name, string pct)
        {
            ViewBag.PrefillName = name;
            ViewBag.PrefillPct = pct;
            return View();
        }
        [HttpGet]
        ...
        // =========================================================
        // REPORTS ke liye JSON endpoints
        // AdmissionController.cs 
        // =========================================================

        [HttpGet]
        public JsonResult GetAllApplicationsJson()
        {
            var list = admissionService.GetAllApplications();
            return Json(list, JsonRequestBehavior.AllowGet);
        }

        [HttpGet]
        public JsonResult GetAllAdmissionSetupsJson()
        {
